...
CHECKPOINT_PATH = Path(
    ...
    "DATASET_PHILIPPINES/checkpoints_cc50_clean_baseline/"
...
def main():
    ...
    print("=== CC50 BEST-CHECKPOINT EVALUATION ===")
    ...
    save_confusion_plot(
        ...
        "CC50 validation confusion matrix — pixel counts",
        annotate=False,
    )
    ...
    save_confusion_plot(
        ...
        "CC50 validation confusion matrix — row normalized",
        annotate=True,
    )
    ...
    print("\nCC50 BEST-CHECKPOINT EVALUATION COMPLETED")
